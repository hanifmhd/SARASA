...
public class DaftarBahasaActivityPercakapan extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_bahasa_percakapan);
        ...
        btn_BahasaJawa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DaftarBahasaActivityPercakapan.this,PercakapanActivity.class);
        ...
        btn_Bahasa1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog alertDialog = new AlertDialog.Builder(DaftarBahasaActivityPercakapan.this).create();
